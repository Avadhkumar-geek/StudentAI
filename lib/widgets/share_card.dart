  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () async {
        ...
        Share.share('https://github.com/Avadhkumar-geek/StudentAI/releases/tag/Latest',
            subject: 'Share App', sharePositionOrigin: box!.localToGlobal(Offset.zero) & box.size);
      },
